  ...
  return (
    <section id="about" className="py-20 px-4 bg-background">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-accent mb-12">About Me</h2>

        <div className="prose prose-lg max-w-4xl text-muted-foreground space-y-6">
          ...
          <p className="leading-relaxed">
            ...
            and hardware-aware quantum machine learning.
          </p>
